...
import { mockedActivitiesArray, mockedCoordinatorsArray, mockedEventsArray } from '../../__mocks__/events.mock';
...
describe('Thunks', () => {
    ...
    beforeEach(() => {
        ...
        mock.onGet(coordinatorsUrl).reply(200, mockedCoordinatorsArray);
    });
